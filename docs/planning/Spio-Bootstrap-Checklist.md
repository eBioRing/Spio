...
- `../operations/Spio-Verification-Matrix.md`

Detailed migration procedure lives in:

- `../operations/Spio-Repo-Split-Runbook.md`
...
- `spio_extractability_gate` is green
- `styio_spio_dual_maintenance_gate` has a documented preflight entry point

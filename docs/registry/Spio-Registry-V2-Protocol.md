# Spio Registry V2 Protocol

**Purpose:** Define the production-oriented `spio` package registry `v2` static read-plane protocol so package clients, mirrors, and backend services can develop independently against the same immutable distribution surface.

**Last updated:** 2026-04-21

## 1. Positioning

`spio` registry `v2` is the active package distribution contract.
...
- `artifacts/source/sha256/<xx>/<yy>/<sha256>.spio.src.tar`
- `artifacts/binary/<target-triple>/sha256/<xx>/<yy>/<sha256>.spio.bin.tar.zst`
- `log/checkpoint.json`
